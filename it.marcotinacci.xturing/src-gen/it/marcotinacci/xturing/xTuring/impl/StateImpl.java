 ...
 * <ul>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.StateImpl#isBeginState <em>Begin State</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.StateImpl#getTransactions <em>Transactions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends MinimalEObjectImpl.Container implements State
{
  ...
  {
    return XTuringPackage.Literals.STATE;
  }
  ...
  public void setBeginState(boolean newBeginState)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.STATE__BEGIN_STATE, oldBeginState, beginState));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.STATE__NAME, oldName, name));
  }
  ...
  public EList<Transaction> getTransactions()
  {
    ...
    {
      transactions = new EObjectContainmentEList<Transaction>(Transaction.class, this, XTuringPackage.STATE__TRANSACTIONS);
    }
    return transactions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XTuringPackage.STATE__TRANSACTIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XTuringPackage.STATE__BEGIN_STATE:
        return isBeginState();
      case XTuringPackage.STATE__NAME:
        return getName();
      case XTuringPackage.STATE__TRANSACTIONS:
