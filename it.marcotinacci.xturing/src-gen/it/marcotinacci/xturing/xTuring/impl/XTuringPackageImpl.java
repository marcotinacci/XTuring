...
import it.marcotinacci.xturing.xTuring.XTuringFactory;
 ...
 * @generated
 */
public class XTuringPackageImpl extends EPackageImpl implements XTuringPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see it.marcotinacci.xturing.xTuring.XTuringPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private XTuringPackageImpl()
  {
    super(eNS_URI, XTuringFactory.eINSTANCE);
  }
   ...
   * 
   * <p>This method is used to initialize {@link XTuringPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static XTuringPackage init()
  {
    if (isInited) return (XTuringPackage)EPackage.Registry.INSTANCE.getEPackage(XTuringPackage.eNS_URI);

    // Obtain or create and register package
    XTuringPackageImpl theXTuringPackage = (XTuringPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof XTuringPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new XTuringPackageImpl());

    isInited = true;

    // Create package meta-data objects
    theXTuringPackage.createPackageContents();

    // Initialize created meta-data
    theXTuringPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theXTuringPackage.freeze();

  
    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(XTuringPackage.eNS_URI, theXTuringPackage);
    return theXTuringPackage;
  }
   ...
   * @generated
   */
  public XTuringFactory getXTuringFactory()
  {
    return (XTuringFactory)getEFactoryInstance();
  }
