 ...
 * <ul>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.ReadWriteSymbolImpl#getSymbol <em>Symbol</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.ReadWriteSymbolImpl#isEmpty <em>Empty</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReadWriteSymbolImpl extends MinimalEObjectImpl.Container implements ReadWriteSymbol
{
  ...
  {
    return XTuringPackage.Literals.READ_WRITE_SYMBOL;
  }
    ...
    if (symbol != null && symbol.eIsProxy())
    {
      ...
      if (symbol != oldSymbol)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XTuringPackage.READ_WRITE_SYMBOL__SYMBOL, oldSymbol, symbol));
      }
    }
    return symbol;
  }
  ...
  public void setSymbol(Symbol newSymbol)
  {
    ...
    symbol = newSymbol;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.READ_WRITE_SYMBOL__SYMBOL, oldSymbol, symbol));
  }
  ...
  public void setEmpty(boolean newEmpty)
  {
    ...
    empty = newEmpty;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.READ_WRITE_SYMBOL__EMPTY, oldEmpty, empty));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XTuringPackage.READ_WRITE_SYMBOL__SYMBOL:
        if (resolve) return getSymbol();
        return basicGetSymbol();
      case XTuringPackage.READ_WRITE_SYMBOL__EMPTY:
        return isEmpty();
    }
