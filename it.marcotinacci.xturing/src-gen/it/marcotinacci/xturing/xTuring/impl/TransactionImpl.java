 ...
 * <ul>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#isReading <em>Reading</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#getRead <em>Read</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#isWriting <em>Writing</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#getWrite <em>Write</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#isMoving <em>Moving</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#getMove <em>Move</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#isNext <em>Next</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#getToState <em>To State</em>}</li>
 *   <li>{@link it.marcotinacci.xturing.xTuring.impl.TransactionImpl#isFinal <em>Final</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TransactionImpl extends MinimalEObjectImpl.Container implements Transaction
{
  ...
  {
    return XTuringPackage.Literals.TRANSACTION;
  }
  ...
  public void setReading(boolean newReading)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.TRANSACTION__READING, oldReading, reading));
  }
  ...
  public EList<ReadWriteSymbol> getRead()
  {
    if (read == null)
    {
      read = new EObjectContainmentEList<ReadWriteSymbol>(ReadWriteSymbol.class, this, XTuringPackage.TRANSACTION__READ);
    }
    return read;
  }
  ...
  public void setWriting(boolean newWriting)
  {
    ...
    writing = newWriting;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.TRANSACTION__WRITING, oldWriting, writing));
  }
  ...
  public EList<ReadWriteSymbol> getWrite()
  {
    if (write == null)
    {
      write = new EObjectContainmentEList<ReadWriteSymbol>(ReadWriteSymbol.class, this, XTuringPackage.TRANSACTION__WRITE);
    }
    return write;
  }
  ...
  public void setMoving(boolean newMoving)
  {
    ...
    moving = newMoving;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.TRANSACTION__MOVING, oldMoving, moving));
  }
  ...
  public void setMove(String newMove)
  {
    ...
    move = newMove;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.TRANSACTION__MOVE, oldMove, move));
  }
  ...
  public void setNext(boolean newNext)
  {
    ...
    next = newNext;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.TRANSACTION__NEXT, oldNext, next));
  }
  ...
  public State getToState()
  {
    if (toState != null && toState.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XTuringPackage.TRANSACTION__TO_STATE, oldToState, toState));
      }
    }
    return toState;
  }
  ...
  public void setToState(State newToState)
  {
    ...
    toState = newToState;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.TRANSACTION__TO_STATE, oldToState, toState));
  }
  ...
  public void setFinal(boolean newFinal)
  {
    ...
    final_ = newFinal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XTuringPackage.TRANSACTION__FINAL, oldFinal, final_));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XTuringPackage.TRANSACTION__READ:
        return ((InternalEList<?>)getRead()).basicRemove(otherEnd, msgs);
      case XTuringPackage.TRANSACTION__WRITE:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XTuringPackage.TRANSACTION__READING:
        return isReading();
      case XTuringPackage.TRANSACTION__READ:
        return getRead();
      case XTuringPackage.TRANSACTION__WRITING:
        return isWriting();
      case XTuringPackage.TRANSACTION__WRITE:
        return getWrite();
      case XTuringPackage.TRANSACTION__MOVING:
        return isMoving();
      case XTuringPackage.TRANSACTION__MOVE:
        return getMove();
      case XTuringPackage.TRANSACTION__NEXT:
        return isNext();
      case XTuringPackage.TRANSACTION__TO_STATE:
        if (resolve) return getToState();
        return basicGetToState();
      case XTuringPackage.TRANSACTION__FINAL:
        return isFinal();
    }
