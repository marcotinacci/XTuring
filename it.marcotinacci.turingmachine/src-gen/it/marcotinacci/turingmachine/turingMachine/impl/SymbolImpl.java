 ...
 * <ul>
 *   <li>{@link it.marcotinacci.turingmachine.turingMachine.impl.SymbolImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SymbolImpl extends MinimalEObjectImpl.Container implements Symbol
{
  ...
  {
    return TuringMachinePackage.Literals.SYMBOL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TuringMachinePackage.SYMBOL__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TuringMachinePackage.SYMBOL__NAME:
        return getName();
    }
